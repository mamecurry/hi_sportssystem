    ...
    @endif
            ...
            <form action="{{ route('reservations.store') }}" method="POST">
                ...
                <div class="mt-10 grid grid-cols-3 gap-6">
                    ...
                    <div class="mt-0 col-span-2 grid grid-cols-3 gap-4">
                    ...
                    <div class="mt-0 col-span-2">
                        <div class="grid grid-cols-5">
                            <div class="col-span-2">
                                <input type="date" name="reservation_datetime" class="w-full">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- 時間帯リスト -->
                <div class="mt-10 grid grid-cols-3 gap-6">
                    <h2 class="text-lg font-medium content-center">{{ __('予約時間') }}</h2>
                    <div class="mt-0 col-span-2">
                        <div class="grid grid-cols-5">
                            <div class="col-span-2">
                                <div>
                    ...
                    <div class="mt-10">
                        <input type="submit" value="{{ __('予約') }}" class="border border-black px-3 py-1">
                    </div>
            </form>
        </div>
    </div>
